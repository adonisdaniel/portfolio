...
export const projectsData: IProject[] = [
  {
    ...
    preview: "https://admin-new.centerhorses.online/",
  },
  {
    title: "CENTER HORSES WEB",
    description:
      "Frontend for center horses game. Here the game can be played.",
    stack: ["VUE 3", "PINIA", "AXIOS", "SSE"],
    preview: "https://web-new.centerhorses.online/",
  },
  {
    ...
    stack: ['VUE 3', 'PINIA', 'AXIOS', 'SOCKET IO'],
    preview: 'https://new_roulette_admin.whatsbet.net/',
  },
  {
